...
func (d *Device) Read(p []byte) (n int, err error) {
	...
	err = nil
	if req_len%2 == 1 {
		return 0, errors.New("Device.Read: odd-sized read not implemented")
	}
	/*
	   mod := 0
	   if req_len % 2 == 1 {
...
func (d *Device) FlashErase(addr int64) error {
	cmd := make([]byte, 8*8)
	addr /= 2
